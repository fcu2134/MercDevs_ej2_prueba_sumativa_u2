...
namespace MercDevs_ej2.Controllers
{
    public class DescripcionserviciosController : Controller
    {
        ...
        {
            if (descripcionservicio.IdDescServ !=0 && descripcionservicio.Nombre !=null && descripcionservicio.ServicioIdServicio !=0 && descripcionservicio.ServicioIdServicioNavigation !=null)
            {
